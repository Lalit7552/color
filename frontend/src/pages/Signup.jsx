...
import { Mail, Lock, User, Gamepad2, UserPlus, Loader2, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0f1e] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900 via-[#0a0f1e] to-black p-4 font-sans">
      ...
      <div className="bg-gray-900/80 backdrop-blur-xl shadow-[0_0_40px_rgba(0,0,0,0.5)] rounded-3xl p-8 w-full max-w-md border border-gray-700/50 relative overflow-hidden">
        ...
        <p className="text-gray-400 text-center mb-6 text-sm">Create your account to start winning!</p>
        ...
        {success && (
          <div className="bg-green-500/10 border border-green-500/50 text-green-400 p-3 rounded-lg mb-5 text-center font-medium shadow-[0_0_10px_rgba(34,197,94,0.2)]">
            {success}
          </div>
        )}
        ...
        <p className="text-center text-sm mt-6 text-gray-400">
          ...
          <Link to="/login" className="text-yellow-400 font-bold hover:text-yellow-300 hover:underline transition-colors">
            Login here
          </Link>
        </p>
      </div>
